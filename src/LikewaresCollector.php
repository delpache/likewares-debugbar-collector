...
class LikewaresCollector extends DataCollector implements DataCollectorInterface, Renderable
{
    use Modules;
    ...
    public function collect()
    {
        ...
        $info = Info::all();
        $likewares_version = ! empty($info['likewares']) ? $info['likewares'] : '0.0.0';
        ...
        return [
            'Likewares Version' => $likewares_version,
